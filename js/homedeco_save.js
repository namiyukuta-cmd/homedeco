(function(){
 ...
 function ensure(){let s=load();if(!s){s=initial();save(s);}return s;}
 ...
 window.HomeDecoSave={KEY,initial,load,save,ensure,reset,hasSave,discardItem,emptyBag,exportSave,importSave};
})();
